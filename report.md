...
Desktop PCs Windows 10 Store Apps (UWP) Windows Win32 (OpenGL & DirectX) Linux (OpenGL) Mac OS X (OpenGL) Mobile/Tablet Devices Android (OpenGL) iPhone/iPad (OpenGL) Windows Phone 10 Television tvOS
...
Consoles (for registered developers) PlayStation 4 (Sony) PlayStation Vita (Sony) Xbox One (both UWP and XDK) (id@xbox) Nintendo Switch (Nintendo)
